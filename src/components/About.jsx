    ...
    return (
        <div className="container">
            ...
            <div>
                ...
                The province is home to two UNESCO World Heritage Sites, namely, the Heritage City of Vigan and the Baroque Church of Santa Maria.</p>
            </div>
        </div>
    )
}
